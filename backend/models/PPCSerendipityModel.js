...
const PPCSerendipitySchema = new Schema({
    pnx: PnxSchema,
...
PPCSerendipitySchema.virtual('@id').get(function() {
    return this.externalId;
});

PPCSerendipitySchema.set('toJSON', { virtuals: true });
PPCSerendipitySchema.set('toObject', { virtuals: true });

module.exports = mongoose.model('PPCSerendipity', PPCSerendipitySchema);
