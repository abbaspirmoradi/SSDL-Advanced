...
const WIOTSerendipitySchema = new Schema({
    pnx: PnxSchema,
...
WIOTSerendipitySchema.virtual('@id').get(function() {
    return this.externalId;
});

WIOTSerendipitySchema.set('toJSON', { virtuals: true });
WIOTSerendipitySchema.set('toObject', { virtuals: true });

module.exports = mongoose.model('WIOTSerendipity', WIOTSerendipitySchema);
